...
const Blog = () => {
    ...
    const fetchComments = async () => {
        try{
            ...
            const {data} = await axios.get(`/api/blog/${id}/comments`, {blogId:id})
    ...
    return data ? (
        <div className="relative">
            <img src={assets.gradientBackground} alt="gradient"
            ...
            <div className="text-center mt-20 text-gray-600">
                ...
                border-primary/35 bg-primary/5 font-medium text-pretty">Michael Brown</p>
            </div>
                ...
                <div className="flex flex-col gap-4">
                    {
                        comments.map((item, index) => (
                            <div key={index} 
                            className="relative bg-primary/2 border border-primary/5 max-w-xl
